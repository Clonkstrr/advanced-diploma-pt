  ...
  components: [
    ...
    // 4 ── annotated visual ──────────────────────────────────────────────────
    {
      ...
      callouts: [
        ...
        { id: 'apt502-u2-v3', label: '3', text: 'The curves are drawn together because facet angle is what makes them behave differently. Lumbar facets set front to back give bending and lock rotation at roughly two degrees a level. The more forward-facing thoracic facets give rotation, and the rib ring restrains it without abolishing it.' },
