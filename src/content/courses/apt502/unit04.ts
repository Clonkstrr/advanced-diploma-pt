...
export const unit04: Unit = {
  ...
  components: [
    ...
    // 3a ── hip shape figure ─────────────────────────────────────────────────
    {
      ...
      callouts: [
        { id: 'apt502-u4-vh1', label: '1', text: 'Read the top row as room to move. A shallower socket covers less of the head and leaves more clearance in deep flexion. A deeper socket runs the neck into the rim sooner. All three figures here sit inside the usual range of about 25 to 39 degrees, none of it is visible from the outside, and none of it is a fault. Outside that range the conversation changes: cover below roughly 25 degrees is dysplasia, an undercovered head that carries genuine instability and arthritis risk, and that is a clinical finding for a clinician rather than a stance preference.' },
...

    {
      ...
      body:
        ...
        '## Two joints at once\n\n' +
        'Three of the four hamstrings cross both the hip and the knee. A muscle that spans two joints like that is called **biarticular**. The fourth one does not, and that asymmetry explains most of what is interesting about the group.\n\n' +
        'Biceps femoris long head, semitendinosus and semimembranosus all leave the ischial tuberosity, the sitting bone, and run on the tibial division of the sciatic nerve. Below the knee they part company: biceps femoris to the head of the fibula on the outside, semimembranosus to the back inner corner of the tibia, and semitendinosus onto the inner face of the tibia at the **pes anserinus**, the shared tendon footprint it forms there with sartorius and gracilis.\n\n' +
        '**Biceps femoris short head** is the exception at both ends. It starts lower down the back of the femur, on the roughened ridge running down the shaft called the linea aspera and on the lateral supracondylar line that continues from it toward the knee, it crosses only the knee, and it takes the common fibular division. It is the one hamstring wired to a different nerve, which is still a live hypothesis for why the long head beside it is the most frequently torn muscle in sport.\n\n' +
    ...
    },
    {
      ...
      body:
        'A client tells you her knee is fine in the gym and horrible on the stairs at work. Leg pressing 140 kilos does not bother her. Walking down two flights to the car park makes her wince at the front of the kneecap. Most trainers hear that and reach for a story about weakness. The more useful story is about shape. Look at what the knee is: two rounded knuckles of femur (the femoral condyles) balanced on an almost flat tibial plateau, with hardly any bony fit between them, asked to be loose enough for a deep squat and steady enough to cut at speed under several times body weight. Everything distinctive about this joint exists to paper over that contradiction.\n\n' +
...

    {
      ...
      body:
        ...
        'The talocrural joint is a slot, called a mortise: the shin bone and its inner knob (the medial malleolus) above and inside, the fibula’s outer knob (the lateral malleolus) outside, the top of the talus in the middle. The talus is wider at the front than the back, so bending the ankle forward drives the wide part into the narrow part of the slot. That makes forward bend the **close-packed position**, where the surfaces fit most tightly, and it means the fibula has to move: a millimetre or two sideways, a little outward twist, a small glide upward, with the joint between the two shin bones widening to allow it. That joint is the distal tibiofibular syndesmosis, the one damaged in a high ankle sprain, and it is why an old sprain can leave forward bend short years later with nothing tight in the muscular sense.\n\n' +
        'The axis is slanted too. It runs roughly between the tips of the two knobs, and the outer knob sits further back and further down than the inner one. So pure up and down ankle motion is a fiction: forward bend comes with a little turn out and roll, and pointing the foot down, which is plantarflexion, comes with a little turn in and tilt.\n\n' +
        ...
        'The better model is a spring that stiffens on command. Hicks described the **windlass mechanism** in 1954 and it has held up. Pulling the toe joints up, especially the big toe, winds the **plantar aponeurosis**, the thick sheet of tissue running along the sole from the heel to the base of the toes, around the heads of the metatarsals like a cable around a drum. That sheet is what most people call the plantar fascia, and the metatarsal heads are the knuckles you can feel at the ball of the foot. Winding it shortens the distance from heel to forefoot, raises the inner arch, supinates the hindfoot and turns a floppy adaptor into a stiff lever for push-off.\n\n' +
        'You can show it to a seated client in ten seconds by lifting her big toe and watching the arch rise. It also explains why a stiff big-toe joint is a problem well beyond the toe: lose that extension and you lose the mechanism that stiffens the whole foot.\n\n' +
    ...
    // 6 ── interactive lab (classification) ──────────────────────────────────
    {
      ...
      items: [
        ...
        { id: 'apt502-u4-l10', text: 'Non-weight-bearing ankle dorsiflexion measures a comfortably normal 20°, but under load she will not let the knee travel forward past the toes',
