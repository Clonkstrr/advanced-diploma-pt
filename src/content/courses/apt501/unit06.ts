...
export const unit06: Unit = {
  ...
  qc: {
    ...
    reviewBy: '2027-08-03',
    jurisdictionNotes:
      'Supplement regulation differs by country and it changes. United States: the Dietary Supplement Health and Education Act (1994) treats supplements as a category of food. There is no pre-market approval for effectiveness, manufacturers are the ones responsible for safety and for backing up their claims, and the FDA generally acts only after products are already on sale. Canada: the Natural Health Products Regulations require a product licence (an NPN) before sale, with evidence supporting the claims made, which is a stricter pre-market system than the American one. Australia and New Zealand: most sports supplements have sat under food law (FSANZ), but since 2020 the TGA has treated sports supplements presented in medicine-like dosage forms with certain claims as therapeutic goods. EU and UK: food supplement rules apply, and in the EU only health claims on the authorised register may be used. Everywhere: third-party programs such as Informed Sport and NSF Certified for Sport test batches for banned-substance contamination and for label content. They say nothing about whether a product works. Verify the current rules where you practise before advising anyone.',
    controversies:
      'Evidence tiers describe average effects, and they get revised. The AIS framework and the ISSN stands are updated as trials accumulate, and honest people disagree about the middle tier (fish oil, curcumin, collagen with vitamin C, ashwagandha) where trials are small, mixed, or sponsored. The claim that creatine harms the kidneys is settled in healthy adults, but it persists publicly because creatine raises serum creatinine, a marker used to estimate kidney function. There is also a real difference between "no evidence that it works" and "evidence that it does not work". Most of the marketing tier is the first of those. A few of its members are now the second.',
  },
  components: [
    // 1 ── diagnostic pretest ────────────────────────────────────────────────
    {
      ...
      questions: [
        { id: 'apt501-u6-p1', kind: 'single', cognitive: 'analysis',
          ...
          options: [
            { id: 'a', text: 'Muscle protein synthesis is a short-term signal, not the outcome the buyer cares about, which is muscle actually gained over months', correct: true, rationale: 'Correct: a raised signal is a hypothesis about muscle growth, not a measurement of it.' },
            { id: 'b', text: '33% is too small a difference to matter', correct: false, rationale: 'The size is not the issue. The thing being measured is.' },
        ...
        { id: 'apt501-u6-p3', kind: 'single', cognitive: 'recall',
          ...
          options: [
            ...
            { id: 'b', text: 'Supplements are mostly regulated as a category of food, so nobody has to prove effectiveness before sale', correct: true, rationale: 'Correct. This single fact explains most of what is wrong with the shelf.' },
    ...
    // 2 ── learning outcomes ─────────────────────────────────────────────────
    {
      ...
      outcomes: [
        ...
        { level: 'application', text: 'Run any claim through the pipeline, whether it arrives in an ad, a post or a client question: what exactly is claimed, what evidence backs it, how big is the effect for this person, and what is the verdict.' },
    ...
    // 3 ── core instruction (five concept blocks, visuals interleaved) ───────
    {
      ...
      body:
        'A client forwards you a video at eleven at night. A lean man in a car park holds up a tub and says the powder “activates mTOR, the master switch for muscle growth.” She wants to know if she should get some. Before you answer anything about that product, look at what kind of sentence he just said.\n\n' +
        '## Two kinds of sentence\n\n' +
        'Fitness claims come in two kinds, and they behave completely differently. A **mechanism claim** says something happens inside the body. A pathway switches on, a hormone rises, fat burning goes up, blood flow improves. An **outcome claim** says something happens to the person. She gains five kilos of muscle in a year, loses four kilos of fat, adds twenty watts, runs the 5k ninety seconds faster. Mechanism claims are about the machinery. Outcome claims are about the woman standing in front of you, and they are the only kind she is actually buying.\n\n' +
        '## The trap, and why it keeps working\n\n' +
        'Here is the trap, and it is the most reliable one in the industry. The mechanism claim is often completely true. Leucine really does raise **muscle protein synthesis**, the short-term signal that tells muscle to build. Caffeine really does block adenosine receptors. Training before breakfast really does raise the share of your energy that comes from fat during the session. Because the mechanism is true and sounds technical, it borrows the authority of science. Then the seller quietly leaves you to finish the sentence yourself. He never says “this adds muscle.” He says “activates the master switch for muscle growth,” and your brain does the rest.\n\n' +
        'You cannot finish that sentence for him, because a body has a lot of steps between a signal and a result, and those steps do not simply add up. Researchers have measured the short burst of signal after a dose, then measured the muscle those same people actually built over the following months. The short-term signal turned out to be a poor guide to the long-term result.\n\n' +
        '> Key idea: a raised signal is a reason to run a trial. It is not the trial.\n\n' +
        '## And then what?\n\n' +
        'So build one habit, and use it out loud every time: and then what? This raises muscle protein synthesis, and then what? It raises fat burning during the session, and then what happened to the fat on the person, measured over weeks, against a group who did the same training without it? If nobody has measured the “and then what” in humans doing roughly what your client does, you are holding a hypothesis with good marketing.\n\n' +
        'Watch the middle case, because it fools careful people. A **surrogate marker** is something measured in a real person in a real lab that stands in for the result you care about: fat burning during a session, blood lactate, testosterone thirty minutes after a dose, a soreness score out of ten. Being measured in humans makes these feel like outcomes. They are not. They are mechanism claims wearing a lab coat. A surrogate earns your trust only once somebody has shown that moving it moves the thing you actually want, and for most supplement marketing nobody has.\n\n' +
        'One more thing, because the logic runs both ways. An outcome with no mechanism behind it is perfectly fine. Coaches were building strong people with progressive overload long before anyone could explain the molecular biology of it, and the explanation arrived late without changing the practice. A result that keeps repeating beats a beautiful mechanism nobody has tested. If you have to choose which half to trust, trust the half that was measured on people.',
    },
    {
      type: 'concept', id: 'apt501-u6-c2', heading: 'Reading an influencer like a researcher',
      body:
        'It would be easy to run this section as a complaint about influencers, and it would teach you nothing. Plenty of the people selling bad information believe it themselves. They got a result, they were sincere, and nobody ever taught them the difference between a result and evidence. What is useful is that their claims fail in a small number of shapes you can learn to spot, and you already have a name for every one of them from earlier in this course.\n\n' +
        '## The wall of before and after photos\n\n' +
        'Start with the transformation grid, because it holds up the whole industry. A wall of photos looks like a mountain of data. It is a sample chosen because it worked. The forty people who bought the same program and did not change were never photographed, never posted and never counted. That is **survivorship bias** in its purest form: the rule for getting into the picture guarantees a positive result whatever the product does.\n\n' +
        'Even for the woman in the photo, the supplement was never tested on its own. She also started training, ate more protein, slept better because she was excited, cut her drinking and dropped water. Add the tan, the lighting, the posture and the pump. That is **confounding**: ten things moved at once, so no photo on earth can tell you which one caused the change.\n\n' +
        '## Studies show, says nobody in particular\n\n' +
        'Then there is “studies show,” with no study named. Notice how cheap a citation is. One line, one link. Now notice what it means when the cheapest possible move is the one nobody made. Where the link is there, follow it, because this is where most claims quietly die. The study often used a different dose, a different form of the compound, a different group of people, or measured something else entirely. A rat study offered as human evidence. A two-hour lab measure offered as a body composition result. Six grams in the trial and eight hundred milligrams in the tub.\n\n' +
        'The single-study leap is the respectable version of the same error. One small trial found something, so now it is a fact. But one trial carries the luck of whoever happened to be in the sample, plus **publication bias**, which is the tendency for studies that found nothing to go unwritten and unprinted, plus a hundred small choices made during the analysis. Your field builds systematic reviews and position stands for exactly this reason: individual studies disagree with each other constantly. A claim resting on one paper honestly reads as “worth watching,” never as “now true.”\n\n' +
        '> Key idea: every failure in this list is the same move. Something real is shown to you, and something unmeasured is left for you to conclude.\n\n' +
        '## Abs are not a qualification\n\n' +
        'Physique as credential deserves its own paragraph, because it is so persuasive and so useless. A visible six-pack is evidence about one person: their genetics, their training history, their age, what they earn, how many hours a week they can train, and in some corners of the industry what they inject. It is a sample of one with every confounder turned up to maximum, and it tells you almost nothing about what will happen to your forty-six-year-old client with two kids and four training hours a week. Being lean proves that someone got lean. It does not prove they know why.\n\n' +
        'The last pattern is the most commercially clever. The person selling the solution is the person who diagnosed the problem. You did not know your cortisol was sabotaging your results until the man who sells the cortisol formula told you, and the worry, the diagnosis and the fix all arrive from one account inside sixty seconds. In a journal that relationship would appear as a declared funding statement, and you would weigh the paper accordingly. On a feed it appears as a link in the bio. Same **conflict of interest**, no declaration.\n\n' +
        'None of this means distrust anyone with abs. Some coaches with enormous followings are careful, and some quiet ones are terrible. The tell is not the platform. It is whether they let you check their work. Do they name the study, the dose and the population? Do they say “I don’t know” out loud? Have you ever watched them change their mind in public? Someone who does those three things is doing science in front of you, whatever their follower count.',
    },
    {
      type: 'visual', id: 'apt501-u6-visual-anatomy',
      title: 'One marketing sentence, taken apart',
      diagramId: 'claim-sentence-anatomy',
      caption: 'A real supplement headline cut into its four fragments, with what the reader hears set beside what the evidence will actually carry.',
      callouts: [
        { id: 'apt501-u6-va1', label: '1', text: 'Read the middle row first. Not one line of it was printed on the tub. The seller supplied four true fragments and let the buyer supply the conclusion, which is the whole design of the format.' },
        { id: 'apt501-u6-va2', label: '2', text: 'Each fragment fails in a different way, so a single objection never kills the page. “Clinically proven” fails on authority, the blend fails on dose, the 43% fails on outcome, and the athlete fails on sample size. You need all four moves.' },
        { id: 'apt501-u6-va3', label: '3', text: 'The 43% column is the one to practise. A big percentage on a small base is a small quantity: about four grams of fat, roughly 36 kilocalories, measured over two hours in twelve young men lying still.' },
        { id: 'apt501-u6-va4', label: '4', text: 'Do this to any label your client sends you, out loud, with her watching. She keeps the method long after she has forgotten the verdict on this particular tub.' },
      ],
    },
    {
      type: 'concept', id: 'apt501-u6-c3', heading: 'What is actually in the tub: an honest tier list',
      body:
        'Two free frameworks do most of the work here. The Australian Institute of Sport publishes a Sports Supplement Framework that sorts products into four groups. Group A has strong evidence in specific situations. Group B is emerging, for use only with monitoring or inside research. Group C has little or no proof of benefit. Group D is banned or carries a high contamination risk. The International Society of Sports Nutrition publishes **position stands**: long referenced reviews on one topic that end by taking a stance instead of hiding behind “more research is needed.” Between them you can grade almost anything a client asks about.\n\n' +
        '## The short list that works\n\n' +
        'The strong tier is short, which is the first honest thing to tell a client. **Creatine monohydrate** is the most studied **ergogenic aid** there is, meaning a substance taken to improve performance. It raises the phosphocreatine stored in muscle, which improves repeated hard efforts, and with resistance training it adds more strength and lean mass than training alone. Three to five grams a day, monohydrate because that is the form the trials used, no loading phase if you can wait a few weeks, and cheaper than a coffee a week.\n\n' +
        'Caffeine is the other genuine performer: roughly three to six milligrams per kilogram of body mass, about an hour before, improving endurance, with good support for muscular endurance, strength and sprint work too. The response varies a lot between individuals, and the sleep cost is real if she trains in the evening. Third on the list is not exciting. Exercising people generally do well on around 1.4 to 2.0 grams of protein per kilogram per day, and a powder is just a convenient way to hit that number. Protein powder is food in a tub.\n\n' +
        '## Real, but only at the margins\n\n' +
        'The situational tier earns its keep for competitive athletes and almost nobody else. **Beta-alanine** raises muscle carnosine over weeks of daily dosing, and carnosine buffers the acid that builds in hard efforts, so the benefit sits in efforts of roughly one to four minutes. It needs four to six grams a day for several weeks, and it makes your skin tingle. Dietary nitrate, usually beetroot juice, can improve endurance, with larger effects in recreational than elite athletes and a fussy dependence on dose and timing. Sodium bicarbonate helps hard efforts of a few minutes, at the price of a gut that may not forgive you. These are real, and they are margins: worth chasing for one percent in a race, and noise for a client whose limiting factor is showing up three times a week.\n\n' +
        '## The tier that pays for the advertising\n\n' +
        '**Branched-chain amino acids** are three of the twenty amino acids, sold as protection against muscle loss, and the mechanism is true: leucine does trigger the building signal. But you cannot build muscle out of three amino acids. You need the full set, and a client eating enough complete protein already gets those three inside her food. Adding them on top does very little, and the claim that they protect muscle through fasted training runs well ahead of anything shown in people.\n\n' +
        'Fat burners are a stimulant with a story attached. Caffeine is the only ingredient in most of them with a defensible effect, its contribution to fat loss over months is small, and the rest of the blend is untested at that dose or untested at all. Detox products offer to remove unnamed toxins your liver and kidneys remove all day anyway, and none has ever shown a named substance leaving the body with a health outcome attached. Testosterone boosters are a category built on hope: in men with normal testosterone the reliable finding is no change worth having in hormones, strength or muscle. A few single ingredients have small, mixed results, none close to the label.\n\n' +
        'There is a legitimate grey zone, and you should not pretend otherwise. Fish oil, curcumin, collagen with vitamin C and ashwagandha sit where trials are small, inconsistent, often industry funded and sometimes promising. The honest phrase is “possible, not established,” which beats the influencer’s sentence and the cynic’s alike. And some supplements are medical rather than performance products: iron, vitamin D, B12. Those are decided by a blood test and a clinician, so a client asking about them gets a referral.\n\n' +
        '> Key idea: training that progresses, food matched to the goal, enough protein, enough sleep and years of consistency account for nearly everything that happens to your client’s body. Supplements work at the edges.\n\n' +
        'Which is why creatine, genuinely worth taking, is still the least interesting thing about a good program. Nobody makes a viral video about it.',
    },
    {
      type: 'visual', id: 'apt501-u6-visual-ladder',
      title: 'From one study to a sentence you can say out loud',
      diagramId: 'claim-evidence-ladder',
      caption: 'Five rungs of evidence, each paired with the strongest thing it lets you say to a client. The recommendation is only ever as strong as the rung underneath it.',
      callouts: [
        { id: 'apt501-u6-vl1', label: '1', text: 'The right column is the point. Grading evidence is only useful if it changes the words that come out of your mouth, so each rung is written as the sentence it buys you.' },
        { id: 'apt501-u6-vl2', label: '2', text: 'Rung 3 is where most supplements live, and it has its own honest sentence. “Possible, not established” is a real answer, and it beats both the sales pitch and the flat refusal.' },
        { id: 'apt501-u6-vl3', label: '3', text: 'Notice what even the top rung refuses to say. A pooled average tells you the effect is real across many people. It never promises that this client is one of them.' },
        { id: 'apt501-u6-vl4', label: '4', text: 'Climbing takes replication, not enthusiasm. A second influencer repeating rung 1 does not move anything up. Only new measurements in people do.' },
      ],
    },
    {
      type: 'concept', id: 'apt501-u6-c4', heading: 'Why “clinically proven” on a label means almost nothing',
      body:
        'Your client turns the tub around in her hand and reads out the reassuring words. Clinically proven. GMP certified. Third-party tested. All natural. Manufactured in an FDA-registered facility. It sounds like a chain of authorities looked at this product and signed it off. Almost none of it means that.\n\n' +
        '## Food law, wearing a medicine costume\n\n' +
        'In most countries supplements are regulated as a category of food, not as medicines. That one sentence explains the industry. A medicine has to prove to a regulator, before it goes on sale, that it does what it claims and that its risks are acceptable. That process is called **pre-market approval**, and it is what the years of trials and the submission file are for. A food only has to be safe to eat and to avoid certain illegal claims. Nobody has to show that a food works, because food is not supposed to make that kind of promise in the first place. Supplements slipped into the food category and then started making medicine-shaped promises.\n\n' +
        '> Key idea: legal to sell means safe enough to eat and not making an illegal claim. It has never meant that anyone checked whether the product works.\n\n' +
        '## What follows from that\n\n' +
        'The consequences run straight downhill. Claims are policed after the fact, unevenly, and usually only when something is bad enough to draw attention. The burden of noticing falls on a regulator, a year after the product started selling.\n\n' +
        'Doses can be hidden. A **proprietary blend** lists its ingredients in descending order of amount and gives you no amounts at all, so “proprietary blend, 1,200 mg” cannot be compared with the dose used in whatever study is being waved at you. That is not sloppy labelling. Concealment is what the format is for.\n\n' +
        'And what is on the label is not always what is in the powder. Independent testing has repeatedly found products holding less of an active ingredient than claimed, more than claimed, or something that was never listed at all, including stimulants and steroid compounds. That is how athletes who never intended to dope end up with a positive test. The IOC consensus statement on supplements treats **contamination** as a first-order risk for exactly that reason.\n\n' +
        '## What a certification logo certifies\n\n' +
        'Third-party certification is where this gets misread most often. Programs such as Informed Sport and NSF Certified for Sport carry out **batch testing**: they screen individual production batches for banned substances and verify that what is on the label is in the product. For a tested athlete that is genuinely valuable, and it is arguably the only supplement decision with a career riding on it. But read what has been certified. It is the absence of contamination, not the presence of an effect. A certified-for-sport fat burner is a clean product that still does not burn fat. Anyone using that logo as proof that something works is either confused or counting on you to be.\n\n' +
        'The details change at every border, and you need to know your own. Some countries require a licence and evidence for claims before sale. Some allow only health claims taken from an authorised list. Some have begun pulling medicine-shaped sports supplements back under medicines regulation. The rules get revised. Check the notes attached to this unit, then check your own regulator, because being confidently wrong about the law in your own country is a bad look on a professional.\n\n' +
        'So what does all this mean with her standing in front of you? You are not the regulator and you do not have to be. Three sentences carry most situations honestly. “Nobody had to prove that works before selling it.” “Here is what the evidence actually supports.” “If you want to try it, we will decide in advance what would count as it working.” And the boundary from your scope work still holds. If a supplement is going anywhere near a prescribed medication or a diagnosed condition, that conversation belongs to a pharmacist, a prescriber or a dietitian. Recommending a specific product puts your professional name on it. Spend that carefully.',
    },
    {
      type: 'visual', id: 'apt501-u6-visual-gates',
      title: 'What a product passed through before it reached the shelf',
      diagramId: 'claim-regulation-gates',
      caption: 'The gates a medicine has to clear set beside the gates a supplement clears under food law, and what a batch-testing logo adds to either route.',
      callouts: [
        { id: 'apt501-u6-vg1', label: '1', text: 'The empty boxes on the right are the whole lesson. Nothing was skipped by accident. Supplements sit in a category that was never designed to carry promises about performance.' },
        { id: 'apt501-u6-vg2', label: '2', text: 'The one gate the supplement does pass sits after the sale, not before it. Policing claims retrospectively means a product can sell for a year before anyone with authority reads the page.' },
        { id: 'apt501-u6-vg3', label: '3', text: 'Both routes end on the same shelf, in the same shop, with the same confident typography. Your client has no way of telling which route a tub took, which is exactly why she asks you.' },
        { id: 'apt501-u6-vg4', label: '4', text: 'Read the bottom panel before you ever recommend a certified product to a tested athlete. It is worth real money to her, and it certifies purity, not effect.' },
      ],
    },
    {
      type: 'concept', id: 'apt501-u6-c5', heading: 'The next big thing, and staying good for twenty years',
      body:
        'Every eighteen months something arrives. Vibration plates, blood-flow restriction, velocity-based training, cold plunges, sauna protocols, Zone 2, whatever is being explained to you this week in a thirty-second video with a whiteboard. Some of it is genuinely useful, most is a real thing described far beyond its evidence, and a little is pure merchandise. You need a test that does not depend on how many people are talking about it, because the volume of the conversation and the strength of the evidence are almost unrelated.\n\n' +
        '## The same pipeline, pointed at a method\n\n' +
        'The pipeline you used on supplements works on methods unmodified. What exactly is being claimed: a mechanism story about muscle oxygen or heart-rate zones, or an outcome somebody measured? Who benefited in the study: trained athletes, untrained beginners, elderly participants, rats? Beginners improve on nearly anything, so a method that looks spectacular in novices may add nothing for a client who has lifted for six years. Then comes the question almost nobody asks. How big was the effect, next to what it costs?\n\n' +
        '**Effect size** means how much the thing actually moved, in units you can picture, rather than whether it moved at all. And cost is never only money. It is equipment, coaching time, session minutes taken from something that was already working, complexity she has to remember, and risk. Whatever the new thing displaces is its **opportunity cost**, usually the expensive part. Three percent is not automatically worth having. A method slightly better on paper and half as enjoyable leaves her worse off.\n\n' +
        '> Key idea: **adherence** is not a soft consideration you add at the end. Whether she is still turning up in March is usually the deciding term in the whole equation.\n\n' +
        'Most trends are a real thing scaled wrong. **Blood-flow restriction**, training with a cuff that limits blood leaving a working limb, genuinely helps when heavy loading is not available, which is why rehabilitation uses it. It was never a replacement for heavy lifting in a healthy person who can lift heavy. Cold exposure does things, and whether those things help a client whose goal is muscle is a different question with a less comfortable answer. So ask of anything new: what problem does this solve, and do my clients have that problem? Usually they have a different one, and it is consistency, sleep or protein.\n\n' +
        '## Keeping yourself current on purpose\n\n' +
        'None of this survives on good intentions, so turn it into a plan. Sources first, and the rule is fewer and better. Position stands and systematic reviews from professional bodies, one or two review journals, the current edition of the textbooks in your field, and a handful of practitioners who cite their sources and admit uncertainty will beat a feed of two hundred accounts. Deliberately keep one careful person you often disagree with. An information diet made only of people who agree with you feels like learning and is closer to grooming.\n\n' +
        'Then schedule it, because unscheduled reading does not happen. An hour a fortnight in the calendar. One topic a quarter you go deep on. One significant review a year. Go in with a question, such as “what does the evidence say about training frequency for my time-poor clients?”, because reading without a question is entertainment you will have forgotten by Thursday.\n\n' +
        'Take your learning goals from your own last twenty clients rather than from what is trending. Where did you hand something off because you were not confident? Which questions made you uncomfortable? Which client type do you quietly avoid booking? That list is your syllabus. Turn each item into something specific, finishable and dated. “By March, be able to program confidently around a client’s menopause symptoms, from two review articles and a workshop” beats “learn more about women’s health” by the width of the room.\n\n' +
        '## Retiring what you used to teach\n\n' +
        'The last part is the hardest, and it separates a professional from a veteran with ten years of the same year. You are going to have to retire things. You will have taught cues and methods for years, sincerely, that the evidence has moved past, and updating will feel like admitting you were wrong in front of people who pay you. Say it plainly anyway. “We used to program this way because that was the best understanding at the time. We know more now, so here is what we are doing instead, and here is why.” Clients trust a coach who updates far more than one who has never changed anything, because they have all met the second kind. And be honest about which kind of update it is. Sometimes the evidence changed. Sometimes it was always there, and you read it better this time.',
    },
    ...
    // 4 ── annotated visual ──────────────────────────────────────────────────
    {
      ...
      caption: 'The four questions that turn any claim into a defensible verdict, whether it arrives as a supplement, a method or a trend.',
      callouts: [
        ...
        { id: 'apt501-u6-v5', label: '5', text: '“Trial cautiously” is a real verdict, not a hedge. It only counts as one if you decide in advance what would count as it working, and when you will check. Otherwise it is a yes with extra steps.' },
      ],
    },
    ...
    // 5 ── worked example ────────────────────────────────────────────────────
    {
      ...
      steps: [
        { id: 'apt501-u6-w1', title: 'Split the sentence into mechanism and outcome',
          reasoning: '“Increases fat burning by 43%” is a mechanism claim about which fuel the body is using. The outcome she is buying is “I will be leaner in eight weeks,” and he never actually said that. She completed the sentence herself, which is the design. So the question becomes: has anyone measured the outcome in people, or only the mechanism?' },
        { id: 'apt501-u6-w2', title: 'Find the study the number came from',
          reasoning: 'The product page cites one paper. Opened, it is a single acute crossover in twelve young men, measuring fuel use over two hours after one dose. Nobody was followed for weeks, no body composition was measured, and no group trained. It is a metabolism study being sold as a fat-loss study: one small trial, on the wrong outcome, in the wrong population.' },
        { id: 'apt501-u6-w3', title: 'Compare the studied dose with what is in the tub',
          reasoning: 'The study used 500 mg of one isolated catechin. The label lists a “1,200 mg proprietary thermogenic blend” of nine ingredients. Because a proprietary blend discloses order but not amounts, the studied ingredient could be 400 mg or 40 mg and you cannot tell. Any claim resting on a study whose dose you cannot confirm is being made on your credulity, not their evidence.' },
        { id: 'apt501-u6-w4', title: 'Convert the effect into units that mean something',
          reasoning: 'A 43% increase on a small base is still small. If she uses roughly ten grams of fat in that two-hour window, a 43% lift is about four grams. That is around 36 kilocalories, less than a third of an apple. And using more fat in one window is not the same as losing fat: over a day, energy balance decides, and the body adjusts what it burns later. The impressive percentage and the trivial quantity are the same number.' },
        { id: 'apt501-u6-w5', title: 'Ask who was studied, and who paid',
          reasoning: 'Twelve lean young men lying in a lab for two hours are not a 46-year-old woman who trains three times a week and eats out on Fridays. The funding line names the ingredient supplier. That does not make the finding false, because sponsored research can be perfectly good, but it does move your starting position, and it makes you ask whether anyone independent has reproduced it. Nobody has.' },
        { id: 'apt501-u6-w6', title: 'Price the decision and give the verdict',
          reasoning: 'Seventy-nine dollars a month, a stimulant load stacked on her morning coffee, mild jitters, and one more thing to remember. All of that is bought against 36 kilocalories measured in a laboratory. Verdict: ignore. The one ingredient in there with real evidence is caffeine, and she already drinks coffee, so she can have that effect for nothing.' },
    ...
    // 6 ── signature lab (evidence appraisal) ────────────────────────────────
    {
      ...
      brief:
        'These five turn up in gyms constantly. Four of them fail, each for a different reason, and one of them holds. For each claim, read what the evidence actually consists of, then grade the strongest support that exists for the claim as stated. Grade the support for the outcome being promised, not for the mechanism underneath it. The list runs roughly weakest to strongest, and the first five rungs are all one failure in different disguises: something real was measured, and it was not the thing being claimed.',
      hierarchy: [
      ...
      claims: [
        { id: 'apt501-u6-cl1',
          ...
          rationale:
            'The mechanism part is true: fasted exercise really does shift fuel use toward fat during the session. That in-session measurement is a surrogate, and it has been carried straight over to a body-composition claim it does not support. The body adjusts what it burns over the rest of the day, and total energy balance decides fat loss. What you can honestly tell a client: train fasted if you prefer it and it sits well with you. It is a preference, not a fat-loss lever.' },
        { id: 'apt501-u6-cl2',
      ...
      nodes: [
        {
          id: 'apt501-u6-n1',
          situation:
            '“I found the thing! Marc’s 6-Week Shred. His clients get incredible results. I ordered the stack last night. Can we build my program around it?”',
          choices: [
            ...
            { id: 'apt501-u6-n1c', text: 'Agree to run the whole protocol, since adherence beats accuracy and she is motivated', to: 'apt501-u6-n3',
        ...
        },
        {
          ...
          choices: [
            ...
            { id: 'apt501-u6-n2c', text: 'Reassure her that if she follows the protocol exactly she will get the same result Marc has', to: null,
              quality: 'poor', feedback: 'You have promised an outcome you cannot deliver, based on one man’s physique, which is the least transferable evidence there is. When the ten weeks do not produce Marc, she will conclude she failed.' },
          ],
        },
        {
          id: 'apt501-u6-n3',
        ...
        },
        {
          ...
          choices: [
            { id: 'apt501-u6-n4a', text: 'Tell her you are not the person to answer that, and to check with her pharmacist or prescriber before taking anything from the tub, holding the recommendation until she has', to: 'apt501-u6-n5',
        ...
        },
        {
          ...
          choices: [
            ...
            { id: 'apt501-u6-n5b', text: 'Tell her to save her money, because the next stack will not do anything either', to: null,
            ...
            { id: 'apt501-u6-n5c', text: 'Let the fasted-cardio belief stand, since it is keeping her consistent and consistency is what matters', to: null,
    ...
    // 8 ── error identification ──────────────────────────────────────────────
    {
      ...
      findings: [
        { id: 'apt501-u6-e1', text: '“I dropped 11 kg in 8 weeks… and I didn’t even join a gym!” with before-and-after photos', isError: true,
          rationale: 'A testimonial is a sample chosen because it worked. The buyers who changed nothing were never photographed. Even for Chloe, the product was never isolated from everything else she changed, and “no gym required” quietly removes the one variable with actual evidence behind it.' },
        { id: 'apt501-u6-e2', text: '“CLINICALLY PROVEN: studies show a 43% increase in fat burning”', isError: true,
          rationale: 'Three failures in one line. No study is named. “Fat burning” is a short-term surrogate rather than fat lost. And a percentage with no base quantity is unreadable, because 43% of a very small number is still a very small number.' },
        ...
        { id: 'apt501-u6-e11', text: '“Not suitable during pregnancy or breastfeeding. If you take prescription medication, speak with your doctor or pharmacist before use.”', isError: false,
          rationale: 'Also not a red flag. It is an appropriate warning that sends the medication question to the right professional, which is the same referral you would make yourself.' },
      ],
    },
    ...
    // 9 ── active-recall set ─────────────────────────────────────────────────
    {
      ...
      cards: [
        { id: 'apt501-u6-r1', front: 'Mechanism claim versus outcome claim: what is the difference, and which is being sold?',
        ...
        { id: 'apt501-u6-r3', front: 'Why is a wall of before-and-after photos not evidence?',
          back: 'It is a sample chosen because it worked. Everyone who did not change was never posted. And each photo confounds the product with training, protein, sleep, water, lighting and pose.' },
        { id: 'apt501-u6-r4', front: 'Name the supplements with genuinely strong evidence.',
          back: 'Creatine monohydrate (3 to 5 g a day, strength and lean mass with resistance training), caffeine (roughly 3 to 6 mg per kg about an hour before), and adequate total protein (around 1.4 to 2.0 g per kg per day for exercising people).' },
        { id: 'apt501-u6-r5', front: 'Which supplements are situational rather than general?',
          back: 'Beta-alanine (efforts of roughly one to four minutes, 4 to 6 g a day for weeks), dietary nitrate or beetroot for endurance, sodium bicarbonate for short high-intensity efforts. They matter for competitors chasing a percent, not for a client who trains three times a week.' },
        ...
        { id: 'apt501-u6-r10', front: 'The three questions for evaluating any new training trend.',
          back: 'What exactly is claimed, mechanism or outcome? Who benefited in the study, and are they like my client? How big is the effect against the cost in money, time, complexity, risk and adherence?' },
    ...
    // 10 ── unit quiz ────────────────────────────────────────────────────────
    {
      ...
      questions: [
        ...
        { id: 'apt501-u6-q2', kind: 'single', cognitive: 'recall',
          ...
          options: [
            { id: 'a', text: 'Supplements are regulated broadly as foods, so no pre-market proof of effectiveness is required', correct: true, rationale: 'Correct. This is the single fact that explains most of the shelf.' },
        ...
        { id: 'apt501-u6-q4', kind: 'single', cognitive: 'application',
          ...
          options: [
            { id: 'a', text: 'Creatine monohydrate, around 3 to 5 g a day', correct: true, rationale: 'Correct: the strongest evidence base of any ergogenic supplement, and it costs very little.' },
        ...
        { id: 'apt501-u6-q5', kind: 'single', cognitive: 'analysis',
          ...
          options: [
            { id: 'a', text: 'In-session fuel use is a surrogate; when trials match calories and follow people for weeks, fat mass changes the same either way', correct: true, rationale: 'Correct: the mechanism is real, the outcome claim does not follow from it.' },
        ...
        { id: 'apt501-u6-q7', kind: 'single', cognitive: 'analysis',
          ...
          explanation: 'Effect size has to be weighed against cost, time, complexity and adherence. A finding in trained athletes may also not transfer to a client whose limiting factor is turning up.',
          options: [
    ...
    // 11 ── teach-back ───────────────────────────────────────────────────────
    {
      ...
      modelAnswer:
        'Honestly? The flavour is the part I would choose on. Here is the thing about BCAAs, and it is not a knock on you for buying them, because the marketing on these is genuinely clever. The science on the label is real: leucine, one of the amino acids in there, does switch on the muscle-building signal. What gets left off is that you can’t build muscle out of three amino acids. You need the full set, and you’re already getting all of them in your protein: chicken, yoghurt, your shake, all of it. So the signal they’re selling you is one your lunch already sent. If your protein was falling short we would be having a real conversation, but yours has been solid for a year. The habit itself, though, I would keep. You drink 700 ml of fluid across a session because of that tub, you never turn up flat, and it is a cue that puts you in work mode. So keep the ritual and stop paying for it. A bottle with a squeeze of cordial does the same job, and if you want to spend that forty dollars a month on something with evidence behind it, five grams of creatine costs about eight. Want me to show you how I checked this one? It took about four minutes, and you can do it to the next thing anyone tries to sell you.',
      rubric: [
        { id: 'apt501-u6-t1', text: 'States the verdict plainly, that BCAAs add little on top of adequate protein, without hedging into false balance' },
    ...
    // 12 ── cumulative review ────────────────────────────────────────────────
    {
      ...
      questions: [
        ...
        { id: 'apt501-u6-cu2', kind: 'multi', cognitive: 'analysis',
          ...
          explanation: 'The observational gap is confounded by who chooses to supplement. The trial gives you the causal estimate, and its size, rather than its p-value, decides whether it is worth anything to a client.',
          options: [
            { id: 'a', text: 'The 20% gap is likely confounded, because people who buy supplements also tend to train, sleep and eat differently', correct: true },
        ...
        { id: 'apt501-u6-cu3', kind: 'single', cognitive: 'synthesis',
          ...
          options: [
            ...
            { id: 'c', text: 'Let her try it, because belief helps adherence and no harm is done', correct: false, rationale: 'It attaches your professional name to a claim you have not checked and teaches her that the next purchase is how progress is made.' },
          ] },
      ],
    },
  ],
