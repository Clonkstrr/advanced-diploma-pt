  ...
  components: [
    ...
    // 3 ── core instruction (five concept blocks) ────────────────────────────
    {
      ...
      body:
        ...
        'Three **cardinal planes** cut the body in that position, and cardinal means the cut passes through its centre of mass. The **sagittal plane** splits left from right, the **frontal plane** (also called coronal) splits front from back, and the **transverse plane** splits top from bottom. Movement in a plane is a turn about an axis, and the axis stands at right angles to the plane it serves. Sagittal motion turns about a mediolateral axis, running side to side. Frontal motion turns about an anteroposterior axis, running front to back. Transverse motion turns about a vertical axis, running up through the part. Hold that pairing and you will never write “flexion in the frontal plane about a mediolateral axis” on an assessment sheet. I have read that sentence on more than one professional document.\n\n' +
    ...
    // 5 ── worked example ────────────────────────────────────────────────────
    {
      ...
      steps: [
        ...
        { id: 'apt502-u1-w6', title: 'Turn geometry into a programming decision',
          reasoning: 'Standing cable adduction and an adduction hold at ninety degrees of hip flexion are not the same exercise for the same muscle. They load it at different joint angles, which means different moment arms, different fibre lengths on the length-tension curve, and different stress at the attachment on the pubic bone. If the aim is to support what happens at the catch, the position of the exercise matters more than the name of the muscle. Programme the geometry, then tell Nadia exactly what you are and are not confident about.' },
      ],
      takeaway:
